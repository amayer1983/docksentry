...
tg, nf = _Tg(), _Notifier()
Broadcast(telegram=tg, notifier=nf).announce(
    "⚡ Auto-update complete: 2 updated",
    detail="\n\n✅ beszel-agent: OK\n✅ Beszel: OK")
...
tg2, nf2 = _Tg(), _Notifier()
Broadcast(telegram=tg2, notifier=nf2).announce("⚡ Auto-updating 2: a, b")
