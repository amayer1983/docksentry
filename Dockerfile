...
# the self-update path could not survive that. It rebuilt the container
...
# it those installs cannot self-update at all, and both testers plus
# every silent user would be stuck until they recreated by hand.
